...
const fileContent = fs.readFileSync("contracts/Greeter.sol").toString();
...
var input = {
  ...
  console.log(output);
  ABI= output.contracts["Greeter.sol"]["Greeter"].abi;
  bytecode=output.contracts["Greeter.sol"]["Greeter"].evm.bytecode.object;
  console.log("abi:",ABI);
